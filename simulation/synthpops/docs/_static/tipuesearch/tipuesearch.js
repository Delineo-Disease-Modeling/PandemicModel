                    ...
                    if (c != 0) {
                        ...
                        for (var i = 0; i < found.length; i++) {
                            if (l_o >= start && l_o < set.show + start) {
                                // BKR: Addition to add searchText=xxx param to search URLs
                                var outUrl = found[i].url + '?searchText=' + d_o;

                                // BKR: Addition to use outUrl instead of found[i].url
                                out += '<div class="tipue_search_content_title"><a href="' + outUrl + '"' + tipue_search_w + '>' + found[i].title + '</a></div>';
                                ...
                                if (set.showURL) {
                                    ...
                                    // BKR: Addition to use outUrl instead of found[i].url
                                    out += '<div class="tipue_search_content_url"><a href="' + outUrl + '"' + tipue_search_w + '>' + s_u + '</a></div>';
                                }
