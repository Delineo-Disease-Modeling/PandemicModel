...
function About(props) {
	...
	<div className='CardBackground'>
		...
		<div class="w3-container w3-padding-32" id="projects">
		    ...
		    <p>The Johns Hopkins Coronavirus Resource Center (CRC) is a continuously updated source of COVID-19 data and expert guidance. We aggregate and analyze the best data available on COVID-19—including cases, as well as testing, contact tracing and vaccine efforts—to help the public, policymakers and healthcare professionals worldwide respond to the pandemic.
		    </p>
		</div>
		<div class="w3-row-padding">
			...
			<div class="w3-display-container">
			    ...
			    <img src="https://coronavirus.jhu.edu/images/covid-in-motion-thumb1009.jpg" alt="House" width="375" height="210" style={{'align-self':'stretch'}}/>
			</div>
		    </div>
		</div>
